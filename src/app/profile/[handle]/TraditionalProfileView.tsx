...
interface TraditionalProfileViewProps {
  profile: ProfileData;
  level: number;
  title: string;
...
export function TraditionalProfileView({ profile, level, title, studyGrid }: TraditionalProfileViewProps) {
  return (
        ...
        <div className="absolute -bottom-12 left-8 flex items-end gap-4">
            <div className="w-24 h-24 bg-background border-[length:var(--border-weight)] border-border shadow-[var(--ui-shadow)] flex items-center justify-center overflow-hidden">
                {profile.avatarUrl ? (
                    ...
                    <span className="font-[family-name:var(--font-primary)] text-3xl font-black text-secondary">
